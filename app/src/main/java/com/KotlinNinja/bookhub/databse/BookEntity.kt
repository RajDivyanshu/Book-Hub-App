...
@Entity(tableName = "books")  // annotation to telling compiler what we are creating(it is an Entities Class)
data class BookEntity(
    @PrimaryKey val book_id:Int,
    @ColumnInfo(name = "book_name") val bookName:String,    //@ColumnInfo(name = "book_name") naming convention in database table
